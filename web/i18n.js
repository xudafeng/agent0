const chinese = {
  ...
  'Skill discovery is disabled.': '技能发现已停用。',
  'Skill directories': '技能目录',
  'Discovery errors': '扫描错误',
  'Choose a skill to add it to your message. Describe the task before sending.': '选择技能，将其添加到消息中。发送前请描述任务。',
  'Skills are discovered when a conversation starts. Start a new conversation to pick up file changes.': '开始对话时会扫描技能。文件变更后，请开始新对话。',
  ...
  'Stop run': '停止运行',
  'TOOL APPROVAL': '工具审批',
  'Allow this tool?': '允许执行这个工具吗？',
  'Deny': '拒绝',
  'Allow once': '仅允许本次',
  'Waiting for approval…': '等待审批…',
  'MCP tool requires approval before execution.': 'MCP 工具执行前需要你的批准。',
  ...
  '{name} needs approval': '{name} 等待审批',
  '{name} approved': '{name} 已批准',
  '{name} denied': '{name} 已拒绝',
  'Run failed': '运行失败',
  'Run stopped': '运行已停止',
